...
```groovy
dependencies{
	implementation "com.github.mncinnovation.mnc-identifiersdk-android:core:1.0.6"
	implementation "com.github.mncinnovation.mnc-identifiersdk-android:ocr:1.0.6"  
}
```
